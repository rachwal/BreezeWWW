...
namespace Breeze
{
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            RegisterSystemBuilder(bundles);

            RegisterComponents(bundles);
        }

        private static void RegisterComponents(BundleCollection bundles)
        {
            bundles.Add(new ScriptBundle("~/Scripts/Components/Index").Include(
                "~/Scripts/Components/Index.js"));

            bundles.Add(new ScriptBundle("~/Scripts/Components/Index/menu").Include(
                "~/Scripts/Components/Index-menu.js"));

            bundles.Add(new ScriptBundle("~/Scripts/Components/Add").Include(
                "~/Scripts/Components/Add.js"));

            bundles.Add(new ScriptBundle("~/Scripts/Components/Add/menu").Include(
                "~/Scripts/Components/Add-menu.js"));

            bundles.Add(new ScriptBundle("~/Scripts/Components/Edit").Include(
                "~/Scripts/Components/Edit.js"));

            bundles.Add(new ScriptBundle("~/Scripts/Components/Edit/menu").Include(
                "~/Scripts/Components/Edit-menu.js"));
        }

        private static void RegisterSystemBuilder(BundleCollection bundles)
        {
            bundles.Add(new ScriptBundle("~/Scripts/SystemBuilder").Include(
                "~/Scripts/SystemBuilder/SystemBuilder.js"));

            bundles.Add(new ScriptBundle("~/Scripts/SystemBuilder/menu").Include(
                "~/Scripts/SystemBuilder/SystemBuilder-menu.js"));

            bundles.Add(new StyleBundle("~/Styles/SystemBuilder").Include(
                "~/Styles/SystemBuilder/SystemBuilder.css"));

            // plugins | loadsh          
            bundles.Add(new ScriptBundle("~/Scripts/SystemBuilder/plugins/loadsh/js").Include(
                "~/Scripts/SystemBuilder/plugins/loadsh/js/lodash.min.js"));

            // plugins | backbone        
            bundles.Add(new ScriptBundle("~/Scripts/SystemBuilder/plugins/backbone/js").Include(
                "~/Scripts/SystemBuilder/plugins/backbone/js/backbone-min.js"));

            // plugins | jointjs         
            bundles.Add(new ScriptBundle("~/Scripts/SystemBuilder/plugins/jointjs/js").Include(
                "~/Scripts/SystemBuilder/plugins/jointjs/js/joint.js"));

            bundles.Add(new StyleBundle("~/Scripts/SystemBuilder/plugins/jointjs/css").Include(
                "~/Scripts/SystemBuilder/plugins/jointjs/css/joint.css"));

            // plugins | touch-punch        
            bundles.Add(new ScriptBundle("~/Scripts/SystemBuilder/plugins/touch-punch/js").Include(
                "~/Scripts/SystemBuilder/plugins/touch-punch/js/jquery.ui.touch-punch.js"));

            // plugins | jscrollpane         
            bundles.Add(new ScriptBundle("~/Scripts/SystemBuilder/plugins/jscrollpane/js").Include(
                "~/Scripts/SystemBuilder/plugins/jscrollpane/js/jquery.jscrollpane.min.js",
                "~/Scripts/SystemBuilder/plugins/jscrollpane/js/jquery.mousewheel.js"));

            bundles.Add(new StyleBundle("~/Scripts/SystemBuilder/plugins/jscrollpane/css").Include(
                "~/Scripts/SystemBuilder/plugins/jscrollpane/css/jquery.jscrollpane.css"));
        }
        ...
        private static void RegisterShared(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/Scripts/Shared/_LoginPartial").Include(
                "~/Scripts/Shared/_LoginPartial.js"));
        }
        ...
        private static void RegisterLayout(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/AdminLTE/plugins/fastclick/js").Include(
                "~/AdminLTE/plugins/fastclick/js/fastclick.js"));
            ...
            bundles.Add(new ScriptBundle("~/AdminLTE/plugins/jquery/js").Include(
                "~/AdminLTE/plugins/jquery/js/jQuery-2.2.0.min.js"));
